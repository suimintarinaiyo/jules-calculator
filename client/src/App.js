...
// OperationButtonコンポーネント
function OperationButton({ dispatch, operation, className = "" }) {
  return (
    <button className={`operator ${className}`} onClick={() => dispatch({ type: ACTIONS.CHOOSE_OPERATION, payload: { operation } })}>
      {operation}
    </button>
  );
}
  ...
  return (
    <div className="calculator">
      ...
      <div className="buttons">
        <button className="clear" onClick={() => dispatch({ type: ACTIONS.CLEAR })}>AC</button>
